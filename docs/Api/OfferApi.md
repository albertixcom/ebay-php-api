...
# **bulkCreateOffer**
> \Albertix\EbayPhpApi\Model\BulkOfferResponse bulkCreateOffer($body)
...
$apiInstance = new Albertix\EbayPhpApi\Api\OfferApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Albertix\EbayPhpApi\Model\BulkEbayOfferDetailsWithKeys(); // \Albertix\EbayPhpApi\Model\BulkEbayOfferDetailsWithKeys | Details of the offer for the channel
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\BulkEbayOfferDetailsWithKeys**](../Model/BulkEbayOfferDetailsWithKeys.md)| Details of the offer for the channel |

### Return type

[**\Albertix\EbayPhpApi\Model\BulkOfferResponse**](../Model/BulkOfferResponse.md)
...
# **bulkPublishOffer**
> \Albertix\EbayPhpApi\Model\BulkPublishResponse bulkPublishOffer($body)
...
$body = new \Albertix\EbayPhpApi\Model\BulkOffer(); // \Albertix\EbayPhpApi\Model\BulkOffer | The base request of the <strong>bulkPublishOffer</strong> method.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\BulkOffer**](../Model/BulkOffer.md)| The base request of the &lt;strong&gt;bulkPublishOffer&lt;/strong&gt; method. |

### Return type

[**\Albertix\EbayPhpApi\Model\BulkPublishResponse**](../Model/BulkPublishResponse.md)
...
# **createOffer**
> \Albertix\EbayPhpApi\Model\OfferResponse createOffer($content_language, $body)
...
$body = new \Albertix\EbayPhpApi\Model\EbayOfferDetailsWithKeys(); // \Albertix\EbayPhpApi\Model\EbayOfferDetailsWithKeys | Details of the offer for the channel
 ...
 **body** | [**\Albertix\EbayPhpApi\Model\EbayOfferDetailsWithKeys**](../Model/EbayOfferDetailsWithKeys.md)| Details of the offer for the channel |

### Return type

[**\Albertix\EbayPhpApi\Model\OfferResponse**](../Model/OfferResponse.md)
...
# **getListingFees**
> \Albertix\EbayPhpApi\Model\FeesSummaryResponse getListingFees($body)
...
$body = new \Albertix\EbayPhpApi\Model\OfferKeysWithId(); // \Albertix\EbayPhpApi\Model\OfferKeysWithId | List of offers that needs fee information
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\OfferKeysWithId**](../Model/OfferKeysWithId.md)| List of offers that needs fee information | [optional]

### Return type

[**\Albertix\EbayPhpApi\Model\FeesSummaryResponse**](../Model/FeesSummaryResponse.md)
...
# **getOffer**
> \Albertix\EbayPhpApi\Model\EbayOfferDetailsWithAll getOffer($offer_id)
...
[**\Albertix\EbayPhpApi\Model\EbayOfferDetailsWithAll**](../Model/EbayOfferDetailsWithAll.md)
...
# **getOffers**
> \Albertix\EbayPhpApi\Model\Offers getOffers($sku, $marketplace_id, $format, $limit, $offset)
...
[**\Albertix\EbayPhpApi\Model\Offers**](../Model/Offers.md)
...
# **publishOffer**
> \Albertix\EbayPhpApi\Model\PublishResponse publishOffer($offer_id)
...
[**\Albertix\EbayPhpApi\Model\PublishResponse**](../Model/PublishResponse.md)
...
> \Albertix\EbayPhpApi\Model\PublishResponse publishOfferByInventoryItemGroup($body)
...
$body = new \Albertix\EbayPhpApi\Model\PublishByInventoryItemGroupRequest(); // \Albertix\EbayPhpApi\Model\PublishByInventoryItemGroupRequest | The identifier of the inventory item group to publish and the eBay marketplace where the listing will be published is needed in the request payload.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\PublishByInventoryItemGroupRequest**](../Model/PublishByInventoryItemGroupRequest.md)| The identifier of the inventory item group to publish and the eBay marketplace where the listing will be published is needed in the request payload. |
...
# **updateOffer**
> \Albertix\EbayPhpApi\Model\OfferResponse updateOffer($offer_id, $content_language, $body)
...
$content_language = "content_language_example"; // string | This request header sets the natural language that will be provided in the field values of the request payload.
$body = new \Albertix\EbayPhpApi\Model\EbayOfferDetailsWithId(); // \Albertix\EbayPhpApi\Model\EbayOfferDetailsWithId | Details of the offer for the channel
 ...
 **content_language** | **string**| This request header sets the natural language that will be provided in the field values of the request payload. |
 **body** | [**\Albertix\EbayPhpApi\Model\EbayOfferDetailsWithId**](../Model/EbayOfferDetailsWithId.md)| Details of the offer for the channel |
...
# **withdrawOffer**
> \Albertix\EbayPhpApi\Model\WithdrawResponse withdrawOffer($offer_id)
...
[**\Albertix\EbayPhpApi\Model\WithdrawResponse**](../Model/WithdrawResponse.md)
...
$body = new \Albertix\EbayPhpApi\Model\WithdrawByInventoryItemGroupRequest(); // \Albertix\EbayPhpApi\Model\WithdrawByInventoryItemGroupRequest | The base request of the <strong>withdrawOfferByInventoryItemGroup</strong> call.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\WithdrawByInventoryItemGroupRequest**](../Model/WithdrawByInventoryItemGroupRequest.md)| The base request of the &lt;strong&gt;withdrawOfferByInventoryItemGroup&lt;/strong&gt; call. |

# Albertix\EbayPhpApi\PromotionApi
...
$apiInstance = new Albertix\EbayPhpApi\Api\PromotionApi(
...
# **getPromotions**
> \Albertix\EbayPhpApi\Model\PromotionsPagedCollection getPromotions($marketplace_id, $limit, $offset, $promotion_status, $q, $sort)
...
[**\Albertix\EbayPhpApi\Model\PromotionsPagedCollection**](../Model/PromotionsPagedCollection.md)

# Albertix\EbayPhpApi\ListingApi
...
# **bulkMigrateListing**
> \Albertix\EbayPhpApi\Model\BulkMigrateListingResponse bulkMigrateListing($body)
...
$apiInstance = new Albertix\EbayPhpApi\Api\ListingApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Albertix\EbayPhpApi\Model\BulkMigrateListing(); // \Albertix\EbayPhpApi\Model\BulkMigrateListing | Details of the listings that needs to be migrated into Inventory
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\BulkMigrateListing**](../Model/BulkMigrateListing.md)| Details of the listings that needs to be migrated into Inventory |

### Return type

[**\Albertix\EbayPhpApi\Model\BulkMigrateListingResponse**](../Model/BulkMigrateListingResponse.md)

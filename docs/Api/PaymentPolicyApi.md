# Albertix\EbayPhpApi\PaymentPolicyApi
...
# **createPaymentPolicy**
> \Albertix\EbayPhpApi\Model\SetPaymentPolicyResponse createPaymentPolicy($body)
...
$apiInstance = new Albertix\EbayPhpApi\Api\PaymentPolicyApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Albertix\EbayPhpApi\Model\PaymentPolicyRequest(); // \Albertix\EbayPhpApi\Model\PaymentPolicyRequest | Payment policy request
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\PaymentPolicyRequest**](../Model/PaymentPolicyRequest.md)| Payment policy request |

### Return type

[**\Albertix\EbayPhpApi\Model\SetPaymentPolicyResponse**](../Model/SetPaymentPolicyResponse.md)
...
# **getPaymentPolicies**
> \Albertix\EbayPhpApi\Model\PaymentPolicyResponse getPaymentPolicies($marketplace_id)
...
[**\Albertix\EbayPhpApi\Model\PaymentPolicyResponse**](../Model/PaymentPolicyResponse.md)
...
# **getPaymentPolicy**
> \Albertix\EbayPhpApi\Model\PaymentPolicy getPaymentPolicy($payment_policy_id)
...
[**\Albertix\EbayPhpApi\Model\PaymentPolicy**](../Model/PaymentPolicy.md)
...
> \Albertix\EbayPhpApi\Model\PaymentPolicy getPaymentPolicyByName($marketplace_id, $name)
...
# **updatePaymentPolicy**
> \Albertix\EbayPhpApi\Model\SetPaymentPolicyResponse updatePaymentPolicy($payment_policy_id, $body)

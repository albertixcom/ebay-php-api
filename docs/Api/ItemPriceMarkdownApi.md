# Albertix\EbayPhpApi\ItemPriceMarkdownApi
...
$apiInstance = new Albertix\EbayPhpApi\Api\ItemPriceMarkdownApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Albertix\EbayPhpApi\Model\ItemPriceMarkdown(); // \Albertix\EbayPhpApi\Model\ItemPriceMarkdown | This type defines the fields that describe an item price markdown promotion.
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\ItemPriceMarkdown**](../Model/ItemPriceMarkdown.md)| This type defines the fields that describe an item price markdown promotion. | [optional]
...
> \Albertix\EbayPhpApi\Model\ItemPriceMarkdown getItemPriceMarkdownPromotion($promotion_id)
...
[**\Albertix\EbayPhpApi\Model\ItemPriceMarkdown**](../Model/ItemPriceMarkdown.md)

# Albertix\EbayPhpApi\LocationApi
...
$apiInstance = new Albertix\EbayPhpApi\Api\LocationApi(
...
$body = new \Albertix\EbayPhpApi\Model\InventoryLocationFull(); // \Albertix\EbayPhpApi\Model\InventoryLocationFull | Inventory Location details
 ...
 **body** | [**\Albertix\EbayPhpApi\Model\InventoryLocationFull**](../Model/InventoryLocationFull.md)| Inventory Location details |
...
> \Albertix\EbayPhpApi\Model\InventoryLocationResponse getInventoryLocation($merchant_location_key)
...
[**\Albertix\EbayPhpApi\Model\InventoryLocationResponse**](../Model/InventoryLocationResponse.md)
...
> \Albertix\EbayPhpApi\Model\LocationResponse getInventoryLocations($limit, $offset)
...
[**\Albertix\EbayPhpApi\Model\LocationResponse**](../Model/LocationResponse.md)
...
$body = new \Albertix\EbayPhpApi\Model\InventoryLocation(); // \Albertix\EbayPhpApi\Model\InventoryLocation | The inventory location details to be updated (other than the address and geo co-ordinates).
 ...
 **body** | [**\Albertix\EbayPhpApi\Model\InventoryLocation**](../Model/InventoryLocation.md)| The inventory location details to be updated (other than the address and geo co-ordinates). |

# Albertix\EbayPhpApi\AdReportTaskApi
...
$apiInstance = new Albertix\EbayPhpApi\Api\AdReportTaskApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Albertix\EbayPhpApi\Model\CreateReportTask(); // \Albertix\EbayPhpApi\Model\CreateReportTask | The container for the fields that define the report task.
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Albertix\EbayPhpApi\Model\CreateReportTask**](../Model/CreateReportTask.md)| The container for the fields that define the report task. |
...
# **getReportTask**
> \Albertix\EbayPhpApi\Model\ReportTask getReportTask($report_task_id)
...
[**\Albertix\EbayPhpApi\Model\ReportTask**](../Model/ReportTask.md)
...
# **getReportTasks**
> \Albertix\EbayPhpApi\Model\ReportTaskPagedCollection getReportTasks($limit, $offset, $report_task_statuses)
...
[**\Albertix\EbayPhpApi\Model\ReportTaskPagedCollection**](../Model/ReportTaskPagedCollection.md)

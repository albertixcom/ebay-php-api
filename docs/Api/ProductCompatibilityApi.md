# Albertix\EbayPhpApi\ProductCompatibilityApi
...
> \Albertix\EbayPhpApi\Model\BaseResponse createOrReplaceProductCompatibility($sku, $content_language, $body)
...
$apiInstance = new Albertix\EbayPhpApi\Api\ProductCompatibilityApi(
...
$body = new \Albertix\EbayPhpApi\Model\Compatibility(); // \Albertix\EbayPhpApi\Model\Compatibility | Details of the compatibility
 ...
 **body** | [**\Albertix\EbayPhpApi\Model\Compatibility**](../Model/Compatibility.md)| Details of the compatibility |
...
> \Albertix\EbayPhpApi\Model\Compatibility getProductCompatibility($sku)
...
[**\Albertix\EbayPhpApi\Model\Compatibility**](../Model/Compatibility.md)

...
class BulkPriceQuantityResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'responses' => '\Albertix\EbayPhpApi\Model\PriceQuantityResponse[]'
    ];
     ...
     * Gets responses
     *
     * @return \Albertix\EbayPhpApi\Model\PriceQuantityResponse[]
     */
     ...
     * Sets responses
     *
     * @param \Albertix\EbayPhpApi\Model\PriceQuantityResponse[] $responses This container will return an HTTP status code, offer ID, and SKU value for each offer/inventory item being updated, as well as an <strong>errors</strong> and/or <strong>warnings</strong> container if any errors or warnings are triggered while trying to update those offers/inventory items.
     *
     * @return $this
     */

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CloneCampaignRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CloneCampaignRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'end_date' => 'string',
        'funding_strategy' => '\Albertix\EbayPhpApi\Model\FundingStrategy',
        'start_date' => 'string'
    ];
     ...
     * Sets campaign_name
     *
     * @param string $campaign_name A seller-defined name for the newly-cloned campaign. This value must be unique for the seller. You can use any alphanumeric characters in the name, except the less than (&lt;) or greater than (&gt;) characters.Max length: 80 characters
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\FundingStrategy
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\FundingStrategy $funding_strategy funding_strategy
     *
     * @return $this
     */

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BulkDeleteAdRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BulkDeleteAdRequest';
     ...
     * Gets requests
     *
     * @return \Albertix\EbayPhpApi\Model\DeleteAdRequest[]
     */
     ...
     * Sets requests
     *
     * @param \Albertix\EbayPhpApi\Model\DeleteAdRequest[] $requests An array of the listing IDs that identify the ads to remove. Note: This request accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).
     *
     * @return $this
     */

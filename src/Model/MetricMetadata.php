 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MetricMetadata implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MetricMetadata';
     ...
     * Sets data_type
     *
     * @param string $data_type The data type of the returned metric value. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/DataTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets metric_key
     *
     * @param string $metric_key The name of the metric.
     *
     * @return $this
     */

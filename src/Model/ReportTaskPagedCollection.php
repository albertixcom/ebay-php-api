 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReportTaskPagedCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReportTaskPagedCollection';
    ...
    protected static $swaggerTypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'report_tasks' => '\Albertix\EbayPhpApi\Model\ReportTask[]',
        'total' => 'int'
    ];
     ...
     * Sets limit
     *
     * @param int $limit Returns the value of the limit as set in the request. This defines the maximum number of reports to return on a page from the result set.
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param int $offset Returns the value of the offset as set in the request. Specifies the number of report tasks to skip in the result set before returning the first report task in the paginated response.
     *
     * @return $this
     */
     ...
     * Sets report_tasks
     *
     * @param \Albertix\EbayPhpApi\Model\ReportTask[] $report_tasks A list of report tasks contained on this page from the paginated response.
     *
     * @return $this
     */

...
class ReportMetadata implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'dimension_metadata' => '\Albertix\EbayPhpApi\Model\DimensionMetadata[]',
        'max_number_of_dimensions_to_request' => 'int',
        'max_number_of_metrics_to_request' => 'int',
        'metric_metadata' => '\Albertix\EbayPhpApi\Model\MetricMetadata[]',
        'report_type' => 'string'
    ];
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\DimensionMetadata[]
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\DimensionMetadata[] $dimension_metadata A list containing the metadata for the dimension used in the report.
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\MetricMetadata[]
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\MetricMetadata[] $metric_metadata A list containing the metadata for the metrics in the report.
     *
     * @return $this
     */

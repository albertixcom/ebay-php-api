...
class OfferKeysWithId implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'offers' => '\Albertix\EbayPhpApi\Model\OfferKeyWithId[]'
    ];

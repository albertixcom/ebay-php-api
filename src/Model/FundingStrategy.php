 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FundingStrategy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FundingStrategy';
     ...
     * Sets funding_model
     *
     * @param string $funding_model Indicates the model that eBay uses to calculate the Promoted Listings fee. Currently, only COST_PER_SALE is supported. Default: COST_PER_SALE For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/FundingModelEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */

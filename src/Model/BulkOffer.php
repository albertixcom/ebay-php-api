...
class BulkOffer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BulkOffer';
    ...
    protected static $swaggerTypes = [
        'requests' => '\Albertix\EbayPhpApi\Model\OfferKeyWithId[]'
    ];
     ...
     * Gets requests
     *
     * @return \Albertix\EbayPhpApi\Model\OfferKeyWithId[]
     */
     ...
     * Sets requests
     *
     * @param \Albertix\EbayPhpApi\Model\OfferKeyWithId[] $requests This container is used to pass in an array of offers to publish. Up to 25 offers can be published with one <strong>bulkPublishOffer</strong> method.
     *
     * @return $this
     */

...
/**
 * BulkGetInventoryItem Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BulkGetInventoryItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BulkGetInventoryItem';
    ...
    protected static $swaggerTypes = [
        'requests' => '\Albertix\EbayPhpApi\Model\GetInventoryItem[]'
    ];
     ...
     * Gets requests
     *
     * @return \Albertix\EbayPhpApi\Model\GetInventoryItem[]
     */
     ...
     * Sets requests
     *
     * @param \Albertix\EbayPhpApi\Model\GetInventoryItem[] $requests The seller passes in multiple SKU values under this container to retrieve multiple inventory item records. Up to 25 inventory item records can be retrieved at one time.
     *
     * @return $this
     */

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DimensionMetadata implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DimensionMetadata';
    ...
    protected static $swaggerTypes = [
        ...
        'dimension_key_annotations' => '\Albertix\EbayPhpApi\Model\DimensionKeyAnnotation[]'
    ];
     ...
     * Sets data_type
     *
     * @param string $data_type The data type of the dimension value used to create the report. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/DataTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets dimension_key
     *
     * @param string $dimension_key The name of the dimension used to create the report.
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\DimensionKeyAnnotation[]
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\DimensionKeyAnnotation[] $dimension_key_annotations An list of annotation keys associated with the specified dimension of the report.
     *
     * @return $this
     */

...
class PriceQuantityResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets errors
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $errors This container will be returned if there were one or more errors associated with the update to the offer or inventory item record.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $warnings This container will be returned if there were one or more warnings associated with the update to the offer or inventory item record.
     *
     * @return $this
     */

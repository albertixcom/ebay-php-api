...
class InventoryLocationFull implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'location' => '\Albertix\EbayPhpApi\Model\LocationDetails',
        ...
        'name' => 'string',
        'operating_hours' => '\Albertix\EbayPhpApi\Model\OperatingHours[]',
        'phone' => 'string',
        'special_hours' => '\Albertix\EbayPhpApi\Model\SpecialHours[]'
    ];
     ...
     * Gets location
     *
     * @return \Albertix\EbayPhpApi\Model\LocationDetails
     */
     ...
     * Sets location
     *
     * @param \Albertix\EbayPhpApi\Model\LocationDetails $location location
     *
     * @return $this
     */
     ...
     *
     * @param string $location_additional_information This text field is used by the merchant to provide additional information about an inventory location. <br><br><b>Max length</b>: 256
     *
     * @return $this
     */
     ...
     *
     * @param string $location_web_url This text field is used by the merchant to provide the Website address (URL) associated with the inventory location. <br><br><b>Max length</b>: 512
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\OperatingHours[]
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\OperatingHours[] $operating_hours Although not technically required, this container is highly recommended to be used to specify operating hours for a store inventory location. This container is used to express the regular operating hours for a store location during each day of the week. A <strong>dayOfWeekEnum</strong> field and an <strong>intervals</strong> container will be needed for each day of the week that the store location is open.
     *
     * @return $this
     */
     ...
     * Gets special_hours
     *
     * @return \Albertix\EbayPhpApi\Model\SpecialHours[]
     */
     ...
     * Sets special_hours
     *
     * @param \Albertix\EbayPhpApi\Model\SpecialHours[] $special_hours This container is used to express the special operating hours for a store inventory location on a specific date, such as a holiday. The special hours specified for the specific date will override the normal operating hours for that particular day of the week.
     *
     * @return $this
     */

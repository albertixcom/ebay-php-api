...
class InventoryItems implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'href' => 'string',
        'inventory_items' => '\Albertix\EbayPhpApi\Model\InventoryItemWithSkuLocaleGroupid[]',
        'next' => 'string',
        'limit' => 'int',
        'prev' => 'string',
        'size' => 'int',
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\InventoryItemWithSkuLocaleGroupid[] $inventory_items This container is an array of one or more inventory items, with detailed information on each inventory item.
     *
     * @return $this
     */

...
class FulfillmentPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'fulfillment_policies' => '\Albertix\EbayPhpApi\Model\FulfillmentPolicy[]',
        'href' => 'string',
        'limit' => 'int',
        'next' => 'string',
        'offset' => 'int',
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\FulfillmentPolicy[] $fulfillment_policies A list of the seller's fulfillment policies.
     *
     * @return $this
     */
     ...
     * Sets href
     *
     * @param string $href Returns a URL link to the result set.
     *
     * @return $this
     */

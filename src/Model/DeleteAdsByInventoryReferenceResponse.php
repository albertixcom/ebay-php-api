 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeleteAdsByInventoryReferenceResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteAdsByInventoryReferenceResponse';
     ...
     * Sets ad_ids
     *
     * @param string[] $ad_ids The list of ad IDs that were removed from the campaign.
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $errors The container for the errors associated with the request.
     *
     * @return $this
     */
     ...
     * Sets status_code
     *
     * @param int $status_code An HTTP status code that indicates the response-status of the request. Check this code to see if the ads were successfully deleted.
     *
     * @return $this
     */

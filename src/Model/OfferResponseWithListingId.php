...
class OfferResponseWithListingId implements ModelInterface, ArrayAccess
{
     ...
     * Sets errors
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $errors This container will be returned if there were one or more errors associated with publishing the offer.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $warnings This container will be returned if there were one or more warnings associated with publishing the offer.
     *
     * @return $this
     */

 ...
 *
 * @category Class
 * @description This complex type defines a promotion as being either a monetary amount or a percentage of a sales price that&#39;s subtracted from the price of an item or order. Set the amount of the discount and the rules that govern when the discount triggers using the &lt;b&gt;discountBenefit&lt;/b&gt; and &lt;b&gt;discountSpecification&lt;/b&gt; fields.
 * @package  Albertix\EbayPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DiscountRule implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DiscountRule';
    ...
    protected static $swaggerTypes = [
        'discount_benefit' => '\Albertix\EbayPhpApi\Model\DiscountBenefit',
        'discount_specification' => '\Albertix\EbayPhpApi\Model\DiscountSpecification',
        'rule_order' => 'int'
    ];
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\DiscountBenefit
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\DiscountBenefit $discount_benefit discount_benefit
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\DiscountSpecification
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\DiscountSpecification $discount_specification discount_specification
     *
     * @return $this
     */
     ...
     * Sets rule_order
     *
     * @param int $rule_order For future use.
     *
     * @return $this
     */

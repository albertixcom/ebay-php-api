...
class PaymentPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'next' => 'string',
        'offset' => 'int',
        'payment_policies' => '\Albertix\EbayPhpApi\Model\PaymentPolicy[]',
        'prev' => 'string',
        'total' => 'int'
    ];
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\PaymentPolicy[] $payment_policies A list of the seller's payment policies.
     *
     * @return $this
     */

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AdResponse';
     ...
     * Sets ad_id
     *
     * @param string $ad_id A unique eBay-assigned ID for an ad. This ID is generated when an ad is created.
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $errors An array of errors associated with the request.
     *
     * @return $this
     */
     ...
     * Sets href
     *
     * @param string $href The URI that points to the ad.
     *
     * @return $this
     */
     ...
     * Sets status_code
     *
     * @param int $status_code An HTTP status code that indicates the response-status of the request. Check this code to see if the ad was successful created.
     *
     * @return $this
     */

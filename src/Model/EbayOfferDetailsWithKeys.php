 ...
 *
 * @category Class
 * @description This type provides details of an offer, and is used by the base request payload of the &lt;strong&gt;createOffer&lt;/strong&gt; call.
 * @package  Albertix\EbayPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EbayOfferDetailsWithKeys implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'listing_policies' => '\Albertix\EbayPhpApi\Model\ListingPolicies',
        'merchant_location_key' => 'string',
        'pricing_summary' => '\Albertix\EbayPhpApi\Model\PricingSummary',
        'quantity_limit_per_buyer' => 'int',
        'tax' => '\Albertix\EbayPhpApi\Model\Tax',
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\ListingPolicies
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\ListingPolicies $listing_policies listing_policies
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\PricingSummary
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\PricingSummary $pricing_summary pricing_summary
     *
     * @return $this
     */
     ...
     * Gets tax
     *
     * @return \Albertix\EbayPhpApi\Model\Tax
     */
     ...
     * Sets tax
     *
     * @param \Albertix\EbayPhpApi\Model\Tax $tax tax
     *
     * @return $this
     */
     ...
     * Sets format
     *
     * @param string $format This enumerated value indicates the listing format of the offer. Currently, the only supported value for this field is <code>FIXED_PRICE</code>, as the Inventory API only supports fixed-price listings at this time.<br/> For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/inventory/types/FormatTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */

...
class SalesTaxes implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'sales_taxes' => '\Albertix\EbayPhpApi\Model\SalesTax[]'
    ];
     ...
     * Sets sales_taxes
     *
     * @param \Albertix\EbayPhpApi\Model\SalesTax[] $sales_taxes A list of sales tax tables that have been set up by a seller.
     *
     * @return $this
     */

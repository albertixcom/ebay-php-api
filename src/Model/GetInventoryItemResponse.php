...
class GetInventoryItemResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sku' => 'string',
        'inventory_item' => '\Albertix\EbayPhpApi\Model\InventoryItemWithSkuLocaleGroupKeys'
    ];
     ...
     * Sets errors
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $errors This container will be returned if there were one or more errors associated with retrieving the inventory item record.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $warnings This container will be returned if there were one or more warnings associated with retrieving the inventory item record.
     *
     * @return $this
     */
     ...
     * Gets inventory_item
     *
     * @return \Albertix\EbayPhpApi\Model\InventoryItemWithSkuLocaleGroupKeys
     */
     ...
     * Sets inventory_item
     *
     * @param \Albertix\EbayPhpApi\Model\InventoryItemWithSkuLocaleGroupKeys $inventory_item inventory_item
     *
     * @return $this
     */

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeleteAdRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteAdRequest';
     ...
     * Sets listing_id
     *
     * @param string $listing_id A unique eBay-assigned ID for a listing that is generated when the listing is created. Note: This request accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).
     *
     * @return $this
     */

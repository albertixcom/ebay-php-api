...
class InventoryLocationResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'location' => '\Albertix\EbayPhpApi\Model\Location',
     ...
     * Gets location
     *
     * @return \Albertix\EbayPhpApi\Model\Location
     */
     ...
     * Sets location
     *
     * @param \Albertix\EbayPhpApi\Model\Location $location location
     *
     * @return $this
     */
     ...
     *
     * @param string $location_additional_information This text field provides additional information about an inventory location. This field is returned if it is set for the inventory location. <br><br><b>Max length</b>: 256
     *
     * @return $this
     */
     ...
     *
     * @param string $location_web_url This text field shows the  Website address (URL) associated with the inventory location. This field is returned if defined for the inventory location. <br><br><b>Max length</b>: 512
     *
     * @return $this
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\OperatingHours[] $operating_hours This container shows the regular operating hours for a store location during the days of the week. A <strong>dayOfWeekEnum</strong> field and an <strong>intervals</strong> container is shown for each day of the week that the store location is open.
     *
     * @return $this
     */
     ...
     * Sets special_hours
     *
     * @param \Albertix\EbayPhpApi\Model\SpecialHours[] $special_hours This container shows the special operating hours for a store location on a specific date or dates.
     *
     * @return $this
     */

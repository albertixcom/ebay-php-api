...
class ReturnPolicyRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets category_types
     *
     * @param \Albertix\EbayPhpApi\Model\CategoryType[] $category_types For return policies, this field can be set to only ALL_EXCLUDING_MOTORS_VEHICLES (returns on motor vehicles are not processed through eBay flows.) Default: ALL_EXCLUDING_MOTORS_VEHICLES (for return policies only)
     *
     * @return $this
     */

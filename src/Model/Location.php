...
class Location implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'address' => '\Albertix\EbayPhpApi\Model\Address',
        'geo_coordinates' => '\Albertix\EbayPhpApi\Model\GeoCoordinates',
        'location_id' => 'string'
    ];
     ...
     * Gets address
     *
     * @return \Albertix\EbayPhpApi\Model\Address
     */
     ...
     * Sets address
     *
     * @param \Albertix\EbayPhpApi\Model\Address $address address
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\GeoCoordinates
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\GeoCoordinates $geo_coordinates geo_coordinates
     *
     * @return $this
     */
     ...
     * Sets location_id
     *
     * @param string $location_id A unique eBay-assigned ID for the location. <br><br> <span class=\"tablenote\"> <strong>Note:</strong> This field should not be confused with the seller-defined <b>merchantLocationKey</b> value. It is the <b>merchantLocationKey</b> value which is used to identify an inventory location when working with inventory location API calls. The <strong>locationId</strong> value is only used internally by eBay.</span>
     *
     * @return $this
     */

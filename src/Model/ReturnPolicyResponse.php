...
class ReturnPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'return_policies' => '\Albertix\EbayPhpApi\Model\ReturnPolicy[]',
        'total' => 'int'
    ];
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\ReturnPolicy[] $return_policies A list of the seller's return policies.
     *
     * @return $this
     */

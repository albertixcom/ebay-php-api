...
class PaymentPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'category_types' => '\Albertix\EbayPhpApi\Model\CategoryType[]',
        'deposit' => '\Albertix\EbayPhpApi\Model\Deposit',
        'description' => 'string',
        'full_payment_due_in' => '\Albertix\EbayPhpApi\Model\TimeDuration',
        'immediate_pay' => 'bool',
        'marketplace_id' => 'string',
        'name' => 'string',
        'payment_instructions' => 'string',
        'payment_methods' => '\Albertix\EbayPhpApi\Model\PaymentMethod[]'
    ];
     ...
     * Gets category_types
     *
     * @return \Albertix\EbayPhpApi\Model\CategoryType[]
     */
     ...
     * Sets category_types
     *
     * @param \Albertix\EbayPhpApi\Model\CategoryType[] $category_types The CategoryTypeEnum value to which this policy applies. Used to discern accounts that sell motor vehicles from those that don't. (Currently, each policy can be set to only one categoryTypes value at a time.)
     *
     * @return $this
     */
     ...
     * Gets deposit
     *
     * @return \Albertix\EbayPhpApi\Model\Deposit
     */
     ...
     * Sets deposit
     *
     * @param \Albertix\EbayPhpApi\Model\Deposit $deposit deposit
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\TimeDuration
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\TimeDuration $full_payment_due_in full_payment_due_in
     *
     * @return $this
     */
     ...
     * Sets marketplace_id
     *
     * @param string $marketplace_id The ID of the eBay marketplace to which the payment policy applies. If this value is not specified, the value defaults to the eBay registration site of the seller. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/account/types/MarketplaceIdEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\PaymentMethod[]
     */

...
class Deposit implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amount' => '\Albertix\EbayPhpApi\Model\Amount',
        'due_in' => '\Albertix\EbayPhpApi\Model\TimeDuration',
     ...
     * Sets amount
     *
     * @param \Albertix\EbayPhpApi\Model\Amount $amount amount
     *
     * @return $this
     */
     ...
     * Sets due_in
     *
     * @param \Albertix\EbayPhpApi\Model\TimeDuration $due_in due_in
     *
     * @return $this
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\PaymentMethod[] $payment_methods A list of accepted payment methods. For deposits (which are applicable to only motor listings), the paymentMethodType must be set to 'PayPal'
     *
     * @return $this
     */

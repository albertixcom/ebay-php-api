...
class MigrateListingResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'inventory_items' => '\Albertix\EbayPhpApi\Model\InventoryItemListing[]',
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\InventoryItemListing[]
     */
     ...
     * Sets errors
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $errors If one or more errors occur with the attempt to migrate the listing, this container will be returned with detailed information on each error.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Albertix\EbayPhpApi\Model\Error[] $warnings If one or more warnings occur with the attempt to migrate the listing, this container will be returned with detailed information on each warning. It is possible that a listing can be successfully migrated even if a warning occurs.
     *
     * @return $this
     */

...
class RuleCriteria implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'exclude_inventory_items' => '\Albertix\EbayPhpApi\Model\InventoryItem[]',
        'exclude_listing_ids' => 'string[]',
        'markup_inventory_items' => '\Albertix\EbayPhpApi\Model\InventoryItem[]',
        'markup_listing_ids' => 'string[]',
        'selection_rules' => '\Albertix\EbayPhpApi\Model\SelectionRule[]'
    ];
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\InventoryItem[] $exclude_inventory_items A list of seller inventory reference IDs to exclude from the promotion. Note: The request can have either excludeInventoryItems or excludeListingIds but not both. Maximum: 100 parent items Maximum SKU or custom label length: 50 characters
     *
     * @return $this
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\InventoryItem[] $markup_inventory_items A list of SKUs to remove from a markdown promotion. The listed SKUs are 'marked up' to their standard price after being part of the markdown promotion.
     *
     * @return $this
     */
     ...
     *
     * @return \Albertix\EbayPhpApi\Model\SelectionRule[]
     */
     ...
     *
     * @param \Albertix\EbayPhpApi\Model\SelectionRule[] $selection_rules Required if: inventoryCriterionType is set to INVENTORY_BY_RULE. The container for the rules that select the items to include in a promotion.
     *
     * @return $this
     */

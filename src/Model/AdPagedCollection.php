 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdPagedCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AdPagedCollection';
    ...
    protected static $swaggerTypes = [
        'ads' => '\Albertix\EbayPhpApi\Model\Ad[]',
        'href' => 'string',
        'limit' => 'int',
        'next' => 'string',
        'offset' => 'int',
     ...
     * Sets ads
     *
     * @param \Albertix\EbayPhpApi\Model\Ad[] $ads A list of ads contained on this page from the paginated response.
     *
     * @return $this
     */
     ...
     * Sets limit
     *
     * @param int $limit Returns the value of the limit as set in the request. This defines the maximum number of ads to return on a page from the result set.
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param int $offset Returns the value of the offset as set in the request. Specifies the number of ads to skip in the result set before returning the first ad in the paginated response.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total The total number of ads in the complete result set.
     *
     * @return $this
     */

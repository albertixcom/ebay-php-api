...
class AdReportTaskApi
{
     ...
     *
     * @param  \Albertix\EbayPhpApi\Model\CreateReportTask $body The container for the fields that define the report task. (required)
     *
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Albertix\EbayPhpApi\Model\ReportTask
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\ReportTask, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportTaskWithHttpInfo($report_task_id)
    {
        $returnType = '\Albertix\EbayPhpApi\Model\ReportTask';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\ReportTask',
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Albertix\EbayPhpApi\Model\ReportTaskPagedCollection
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\ReportTaskPagedCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportTasksWithHttpInfo($limit = null, $offset = null, $report_task_statuses = null)
    {
        $returnType = '\Albertix\EbayPhpApi\Model\ReportTaskPagedCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\ReportTaskPagedCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;

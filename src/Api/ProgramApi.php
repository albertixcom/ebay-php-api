...
class ProgramApi
{
     ...
     * @return \Albertix\EbayPhpApi\Model\Programs
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\Programs, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOptedInProgramsWithHttpInfo()
    {
        $returnType = '\Albertix\EbayPhpApi\Model\Programs';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\Programs',
     ...
     *
     * @param  \Albertix\EbayPhpApi\Model\Program $body Program being opted-in to. (required)
     *
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     *
     * @param  \Albertix\EbayPhpApi\Model\Program $body Program being opted-out of. (required)
     *
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object

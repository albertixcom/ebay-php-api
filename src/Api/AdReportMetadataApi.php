...
class AdReportMetadataApi
{
     ...
     * @return \Albertix\EbayPhpApi\Model\ReportMetadatas
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\ReportMetadatas, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportMetadataWithHttpInfo()
    {
        $returnType = '\Albertix\EbayPhpApi\Model\ReportMetadatas';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\ReportMetadatas',
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Albertix\EbayPhpApi\Model\ReportMetadata
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\ReportMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportMetadataForReportTypeWithHttpInfo($report_type)
    {
        $returnType = '\Albertix\EbayPhpApi\Model\ReportMetadata';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\ReportMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;

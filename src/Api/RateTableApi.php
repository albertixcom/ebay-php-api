...
class RateTableApi
{
     ...
     * @return \Albertix\EbayPhpApi\Model\RateTableResponse
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\RateTableResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRateTablesWithHttpInfo($country_code = null)
    {
        $returnType = '\Albertix\EbayPhpApi\Model\RateTableResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\RateTableResponse',

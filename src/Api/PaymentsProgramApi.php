...
class PaymentsProgramApi
{
     ...
     * @return \Albertix\EbayPhpApi\Model\PaymentsProgramResponse
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\PaymentsProgramResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentsProgramWithHttpInfo($marketplace_id, $payments_program_type)
    {
        $returnType = '\Albertix\EbayPhpApi\Model\PaymentsProgramResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\PaymentsProgramResponse',

...
class ItemPromotionApi
{
     ...
     *
     * @param  \Albertix\EbayPhpApi\Model\ItemPromotion $body This type defines the fields that describe an item promotion. (optional)
     *
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Albertix\EbayPhpApi\Model\ItemPromotionResponse
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\ItemPromotionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemPromotionWithHttpInfo($promotion_id)
    {
        $returnType = '\Albertix\EbayPhpApi\Model\ItemPromotionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\ItemPromotionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;

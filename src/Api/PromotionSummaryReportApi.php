...
class PromotionSummaryReportApi
{
     ...
     * @return \Albertix\EbayPhpApi\Model\SummaryReportResponse
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\SummaryReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPromotionSummaryReportWithHttpInfo($marketplace_id)
    {
        $returnType = '\Albertix\EbayPhpApi\Model\SummaryReportResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\SummaryReportResponse',

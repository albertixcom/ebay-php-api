...
class PrivilegeApi
{
     ...
     * @return \Albertix\EbayPhpApi\Model\SellingPrivileges
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\SellingPrivileges, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPrivilegesWithHttpInfo()
    {
        $returnType = '\Albertix\EbayPhpApi\Model\SellingPrivileges';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\SellingPrivileges',

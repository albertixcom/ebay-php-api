...
class ListingApi
{
     ...
     *
     * @param  \Albertix\EbayPhpApi\Model\BulkMigrateListing $body Details of the listings that needs to be migrated into Inventory (required)
     *
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Albertix\EbayPhpApi\Model\BulkMigrateListingResponse
     */
     ...
     * @throws \Albertix\EbayPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Albertix\EbayPhpApi\Model\BulkMigrateListingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkMigrateListingWithHttpInfo($body)
    {
        $returnType = '\Albertix\EbayPhpApi\Model\BulkMigrateListingResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Albertix\EbayPhpApi\Model\BulkMigrateListingResponse',
